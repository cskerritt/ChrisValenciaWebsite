...
export const GET: APIRoute = async () => {
  ...
  const pageDescriptions: Record<string, string> = {
    ...
    '/travel/': 'Planning a visit from outside Rhode Island: airports, trains, drive times, where to stay, and how booking works from anywhere.',
  ...
  const lines: string[] = [
    ...
    '',
    '## Traveling from outside Rhode Island',
    '',
    `Booking from out of state works the same as booking locally: the form works from anywhere and the design conversation happens over email before travel. Full guide: ${url('/travel/')}.`,
    '',
    '- Closest airport: Rhode Island T.F. Green International (PVD) in Warwick, about 15 minutes from the shop. Boston Logan (BOS) is about an hour by car.',
    "- Train: Amtrak's Northeast Regional and Acela and the MBTA commuter rail stop at Providence station, about 10 minutes from the shop.",
    '- Drive times: Boston about 1 hour; Worcester about 50 minutes; Hartford and Cape Cod about 1 hour 15; New Haven about 1 hour 45; New York City about 3 hours.',
    '- Where to stay: downtown Providence (about 10 minutes away) or the airport hotels in Warwick (about 15 minutes away).',
    '- Cover-ups and large pieces need an in-person consultation before anything is promised; plan those trips accordingly.',
    '',
    '## Portfolio',
    '',
